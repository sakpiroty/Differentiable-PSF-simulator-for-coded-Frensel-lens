...
I have confirmed that this project works on a Windows PC with a GeForce RTX 5090.

Example of the simulated PSFs in different aperture conditions.
...
・opt_3D.py: optimizing the coded aperture in specific optical configuration of the coded large-aperture projector using Fresnel lens.<br>
・PSF_in_depth.py: PSF simulation using a certain mask (totally-open, random, optimized etc.).<br>
